...
# for stereo freq = 19k sample rate is 240k or 250 k (depending on mode) ncoScale = 2.0

# for RDS freq = 114k sample rate is 240k or 250k (depending on mode) ncoScale = 0.5 and 
# normBandwidth start with 0.005 and then reduce by 0.001 if PLL not locking
# phaseAdjust decided after staring at IQ constellations
...
def fmPll(pllIn, freq, Fs, \
	...
	# return last integrator, phaseEst, feedbackI, feedbackQ, last ncoOut
	# trigOffset update it by size of block 
